...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://aco-habitat.fr/guide/${slug}`,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            publisher: {
              ...
              logo: {
                "@type": "ImageObject",
                url: "https://aco-habitat.fr/images/logo-aco-habitat.png",
              },
            },
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://aco-habitat.fr/guide/${slug}`,
            },
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "Guides",
                item: "https://aco-habitat.fr/guide",
              },
              {
                "@type": "ListItem",
                position: 3,
                name: guide.title,
                item: `https://aco-habitat.fr/guide/${slug}`,
              },
            ],
          }),
        }}
